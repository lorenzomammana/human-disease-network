...
plot_graph(UD_nogenes, "dh", UD_nogenes_closeness, E(UD_nogenes)$weight, 0.11, 0.09, 0.07, nodes$label[nodes$X0 == "disease"], 0.11, "Human Disease Network (nogenes) Closeness Centrality")

# node with the highest closeness
V(UD_nogenes)$label[UD_nogenes_closeness==max(UD_nogenes_closeness)] # "Diabetes mellitus" cambiato da quello senza pesi e con geni
```
...
```{r UD_nogenes_eigen}
plot_graph(UD_nogenes, "dh", UD_nogenes_eigen$vector, E(UD_nogenes)$weight, 0.6, 0.04, 0.001, nodes$label[nodes$X0 == "disease"], 0.6, "Human Disease Network (nogenes) Eigenvector Centrality")
