...
ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") +
  geom_node_point(aes(size = UD_nogenes_degree$res, colour=UD_nogenes_degree$res)) + 
  labs(size="degree", colour="degree") +
  theme_graph(base_size = 11, base_family = "sans") +
  ggtitle("Human Disease Network (nogenes) Degree Centrality") 
...
ggraph(UD_nogenes, layout = 'kk') + 
  geom_edge_fan(colour = "gray") + 
  geom_node_point(aes(size = ifelse(UD_nogenes_betweenness > .08, 20, UD_nogenes_betweenness+5), colour = UD_nogenes_betweenness)) +
  theme_graph(base_family = "sans", base_size = 11) +
  #geom_node_label(aes(label = ifelse(betweenness > .12, levels(nodes$label), NA), size = 2)) +
  labs(size="betweenness", col="betweenness") +
  ggtitle("Human Disease Network (niogenes) Betweenness Centrality") 
...
ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") +
  geom_node_point(aes(size = UD_nogenes_pagerank$vector)) +
  theme_graph(base_family = "sans", base_size = 11) +
  labs(size="pagerank") +
  ggtitle("Human Disease Network (nogenes) Pagerank Centrality") 
...
ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") +
  geom_node_point(aes(size = UD_nogenes_eigen$vector)) +
  theme_graph(base_family = "sans", base_size = 11) +
  labs(size="eigenvector") +
  ggtitle("Human Disease Network (nogenes) Eigenvector Centrality") 
