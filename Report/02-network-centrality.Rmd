...
Il grado di un nodo è il numero di archi entranti o uscenti. Formalmente, l'outdegree di un nodo i è dato da $\sum_{j=1}^{n} A_{ij}$ mentre l'indegree di un nodo j è dato da $\sum_{i=1}^{n} A_{ij}$. 
