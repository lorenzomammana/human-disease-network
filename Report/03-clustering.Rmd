...
L'adjusted Rand index (ARI) misura l'accuratezza (FIXME: purity?) dei raggruppamenti costruiti dagli algoritmi utilizzando la seguente formula applicata sulla tabella di contingenza dei risutlati dell'algoritmo:
