...
unclassified_disease %>% select(label, Betweenness, Fastgreedy, Louvain, Spinglass, Markov, Leiden, Label_prop, Label_prop_init)
```
...
head(multiple_disease %>% select(label, Betweenness, Fastgreedy, Louvain, Spinglass, Markov, Leiden, Label_prop, Label_prop_init), 10)
```
