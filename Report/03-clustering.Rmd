...
ggraph(UD_nogenes, layout = 'kk') +
  ...
  geom_node_point(aes(colour = betweennes.communities$membership)) +
  labs(col="cluster") +
  scale_color_gradientn(colours = rainbow(5)) +
  theme_graph(base_family = "sans", base_size = 11) +
  ggtitle("Girvan–Newman clusters")
```
...
ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") + 
  geom_node_point(aes(colour = leiden.communities$membership)) +
  labs(col="cluster") +
  scale_color_gradientn(colours = rainbow(5)) +
  theme_graph(base_family = "sans", base_size = 11) +
  ggtitle("Louvain clusters")
...
ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") + 
  geom_node_point(aes(colour = label_prop.communities$membership)) +
  labs(col="cluster") +
  scale_color_gradientn(colours = rainbow(5)) +
  theme_graph(base_family = "sans", base_size = 11) +
  ggtitle("Label Propagation clusters")
```
...
ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") + 
  geom_node_point(aes(colour = label_prop_init.communities$membership)) +
  labs(col="cluster") +
  scale_color_gradientn(colours = rainbow(5)) +
  theme_graph(base_family = "sans", base_size = 11) +
  ggtitle("Label Propagation clusters")
