...
```{r Girvan–Newman Clusters message=FALSE, warning=FALSE}
...
plot_pretty_graph(UD_nogenes, "graphopt", betweennes.communities$membership, 
                  length(betweennes.communities), E(UD_nogenes)$weight, 
...
plot_pretty_graph(UD_nogenes, "graphopt", leiden.communities$membership, 
                  length(leiden.communities), E(UD_nogenes)$weight, "Leiden Clusters")
```
...
plot_pretty_graph(UD_nogenes, "graphopt", label_prop.communities$membership, 
                  length(label_prop.communities), E(UD_nogenes)$weight, 
...
plot_pretty_graph(UD_nogenes, "graphopt", label_prop_init.communities$membership, 
                  length(label_prop_init.communities), E(UD_nogenes)$weight, 
