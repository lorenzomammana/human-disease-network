...
print(paste("Media della media dei pesi dei clusters individuati 
            con l'algoritmo Leiden: ", 
...
\newpage
```{r}
panderOptions('table.split.table', 8*16)
...
multiple_disease <- head(multiple_disease %>% select(label, Betweenness, Fastgreedy, Louvain, Spinglass, 
