...
```
FIXME: sistemare i prossimi due capitoli per plottare delle tabelle decenti
...
unclassified_disease %>% select(label, Betweenness, Fastgreedy, Louvain, Spinglass, 
...
head(multiple_disease %>% select(label, Betweenness, Fastgreedy, Louvain, Spinglass, 
