...
UD_springlass #IGRAPH clustering spinglass, groups: 43 (communities), mod: 0.4 

V(UD_nogenes)[UD_springlass[[5]]]$X1

ggraph(UD_nogenes, layout = 'kk') +
  geom_edge_fan(colour = "gray") + 
  geom_node_point(aes(colour = UD_springlass$membership)) +
  labs(col="cluster") +
  scale_color_gradientn(colours = rainbow(5)) +
  theme_graph(base_family = "sans", base_size = 11) +
